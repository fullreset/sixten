...
import qualified Text.Parsix.Highlight as Parsix
...
reserved = Parsix.reserve idStyle
...
-------------------------------------------------------------------------------
-- * Definitions
topLevel :: Parser (SourceLocation, TopLevelDefinition)
topLevel = located
  $ dataDef
  <|> classDef
  <|> instanceDef
...
modul :: Parser (Module [(SourceLocation, Unscoped.TopLevelDefinition)])
